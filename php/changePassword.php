...
<html lang = "en">
  <head>
    <meta charset = "utf-8">
      ...
      <title>Modifier Password | Bibliothèque en ligne</title>
				...
				<div class = "limiter">
					<div class = "container-login100">
						<div class = "wrap-login100">
							...
							<form class = "login100-form" name = "form_code_sécurite" id = "form_code_securite" method = "POST" action = "#" onsubmit = "return testEgalitePassword();">
								<span class = "login100-form-title">
									Nouveau Password
								</span>
                <div id = "error_message"></div>
								<div class = "wrap-input100">
									<input class = "input100" type = "password" name = "new_password" id = "new_password" placeholder = "Nouveau Password *"required>
									<span class = "focus-input100"></span>
									<span class = "symbol-input100">
										<i class = "fa fa-lock" aria-hidden = "true"></i>
									</span>
                  <span toggle = "#new_password, #rep_new_password" class = "fa fa-fw fa-eye field-icon toggle-password"></span>
								</div>
                <div class = "wrap-input100">
									<input class = "input100" type = "password" name = "rep_new_password" id = "rep_new_password" placeholder = "Repeter Password *"required>
									<span class = "focus-input100"></span>
									<span class = "symbol-input100">
										<i class = "fa fa-lock" aria-hidden = "true"></i>
									</span>
