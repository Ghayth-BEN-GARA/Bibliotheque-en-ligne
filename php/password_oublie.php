...
<html lang = "en">
  <head>
    <meta charset = "utf-8">
      ...
      <title>Password oublié | Bibliothèque en ligne</title>
				...
				<div class = "limiter">
					<div class = "container-login100">
						<div class = "wrap-login100">
							...
							<form class = "login100-form" name = "form_password_oublie" id = "form_password_oublie" method = "POST" action = "#" onsubmit = "return testExistUtilisateurPasswordOublie();">
								<span class = "login100-form-title">
									Password oublié
								</span>
                <div id = "error_message"></div>
								<div class = "wrap-input100">
									<input class = "input100" type = "email" name = "email_password_oublie" id = "email_password_oublie" placeholder = "Email *"required>
