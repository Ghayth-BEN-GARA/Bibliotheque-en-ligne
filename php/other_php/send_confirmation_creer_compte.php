<?php
  ...
  $mail ->Subject = "Confirmation du création du compte";
  $mail ->Sender = ("miniprojet.groupec@gmail.com");
  $mail ->Body = "<p>Félicitations $prenom, votre nouveau compte a été créé avec succés. vous pouvez utiliser votre compte normalment..</p>
          <br>
