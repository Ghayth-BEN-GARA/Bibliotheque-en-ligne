<?php
  ...
  $code = $_GET['code'];
  $email = $_GET['email'];
  $sql = "UPDATE livre_reserve SET etat_reservation = 'Accepté' WHERE code_reservation = '$code'";
  if (mysqli_query($cnx, $sql)) {
    ...
    $message = "Votre demande de réservation a été accepté. Vous trouvez dans la liste des livres le livre demandé.";
