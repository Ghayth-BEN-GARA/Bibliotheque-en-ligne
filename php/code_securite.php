...
<html lang = "en">
  <head>
    <meta charset = "utf-8">
      ...
      <title>Code de sécuirté | Bibliothèque en ligne</title>
				...
				<div class = "limiter">
					<div class = "container-login100">
						<div class = "wrap-login100">
							...
							<form class = "login100-form" name = "form_code_sécurite" id = "form_code_securite" method = "POST" action = "#" onsubmit = "return decryptCode();">
								<span class = "login100-form-title">
									Code de sécurité
								</span>
                <div id = "error_message"></div>
								<div class = "wrap-input100">
									<input class = "input100" type = "number" name = "code_securite" id = "code_securite" placeholder = "Code de sécurité *"required>
